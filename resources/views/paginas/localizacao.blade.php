            ...
            <div class="col-md-8">
                <div class="contact-form">
                    ...
                    <form action="#" class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="cidade" class="form-control main" placeholder="Cidade" required>
                        </div>
                        {{-- <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="estado" class="form-control main" placeholder="Estado" required>
                        </div>
                        <!-- phone -->
                        <div class="col-md-6">
                            <input type="text" name="telefone" class="form-control main" placeholder="Telefone" required>
                        </div>
                        <!-- email -->
                        <div class="col-md-6">
                        ...
                        <!-- message -->
                        <div class="col-md-12">
                            <textarea name="mensagem" rows="15" class="form-control main" placeholder="Mensagem"></textarea>
                        </div>
                        <!-- submit button -->
                        <div class="col-md-12 text-right">
                            <button class="btn btn-style-one" type="submit">Enviar Mensagem</button>
                        </div>
                    </form>
                    <!-- contact form end -->
                </div>
